...
#cgo linux CFLAGS: -I/usr/include/libusb-1.0 -DDEFAULT_VISIBILITY="" -DOS_LINUX -DPOLL_NFDS_TYPE=int
#cgo linux,!android LDFLAGS: -lrt -lusb-1.0
#cgo darwin CFLAGS: -DOS_DARWIN
#cgo darwin LDFLAGS: -framework CoreFoundation -framework IOKit
#cgo windows CFLAGS: -DOS_WINDOWS -Wno-stringop-overflow
#cgo windows LDFLAGS: -lsetupapi
#ifdef OS_LINUX
	#include "./internal/hidapi/libusb-hid.c"
#elif OS_DARWIN
	#include "./internal/hidapi/osx-hid.c"
#elif OS_WINDOWS
	#include "./internal/hidapi/win-hid.c"
#endif
*/
import "C"
